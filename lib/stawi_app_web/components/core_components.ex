defmodule StawiAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StawiAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StawiAppWeb.Gettext, "errors", msg, opts)
    end
  end
