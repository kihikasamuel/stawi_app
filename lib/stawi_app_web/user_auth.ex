defmodule StawiAppWeb.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      StawiAppWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  defp signed_in_path(_conn), do: ~p"/app/home"
