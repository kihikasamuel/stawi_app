defmodule StawiApp.Reports do
  ...
  def dashboard_summary do
    ...
    today_sales_total = to_decimal(today_sales.total)
    ...
    month_sales = to_decimal(month_sales_raw)
    ...
    month_expenses = to_decimal(month_expenses_raw)
  ...
  def income_statement do
    ...
    revenues =
      ...
      |> Enum.map(&%{name: &1.name, code: &1.code, amount: to_decimal(&1.balance)})
    ...
    cogs_amount = if cogs_account, do: to_decimal(cogs_account.balance), else: Decimal.new("0.0")
